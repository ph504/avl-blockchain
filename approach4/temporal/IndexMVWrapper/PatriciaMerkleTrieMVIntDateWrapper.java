...
import approach4.temporal.PatriciaMerkleTrieMVIntDate;
...
public class PatriciaMerkleTrieMVIntDateWrapper implements IIndexMVIntDate {

    private PatriciaMerkleTrieMVIntDate index = null;

    public PatriciaMerkleTrieMVIntDateWrapper() throws Exception {
        this.index = new PatriciaMerkleTrieMVIntDate();
    }
    ...
    public void delete(Integer key) throws Exception {
        throw new Exception("delete not supported in Patricia Merkle Tree index");
    }
